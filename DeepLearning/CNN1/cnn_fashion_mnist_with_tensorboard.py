...
weights = {
    ...
    'wd1': tf.get_variable('wd1', [7*7*16, 512], initializer=tf.contrib.layers.xavier_initializer(uniform=True)),
    # 1024 inputs, 10 outputs (class prediction)
    'out': tf.get_variable('wout', [512, num_classes], initializer=tf.contrib.layers.xavier_initializer(uniform=True))
}

biases = {
    'bc1': tf.get_variable('bc1', [16], initializer=tf.zeros_initializer()),
    'bc2': tf.get_variable('bc2', [16], initializer=tf.zeros_initializer()),
    'bd1': tf.get_variable('bd1', [512], initializer=tf.zeros_initializer()),
